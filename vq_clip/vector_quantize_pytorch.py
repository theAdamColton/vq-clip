"""
Code from https://github.com/lucidrains/vector-quantize-pytorch
Thanks lucidrains 
"""
...
def gumbel_sample(
    ...
    st_mult = one_hot.gather(
        -1, rearrange(ind, "... -> ... 1")
    )  # multiplier for straight-through
...
class EuclideanCodebook(nn.Module):
    ...
    def forward(self, x, sample_codebook_temp=None):
        ...
        embed_ind, embed_onehot, straight_through_mult = self.gumbel_sample(
...
class VectorQuantize(nn.Module):
    ...
    def forward(self, x, indices=None, mask=None, sample_codebook_temp=None):
        ...
        quantize, embed_ind, distances = self._codebook(
            x, sample_codebook_temp=sample_codebook_temp
        )

        if self.training:
            maybe_sync_update = 0.0
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.layers = nn.ModuleList(
            [
                VectorQuantize(accept_image_fmap=accept_image_fmap, **kwargs)
